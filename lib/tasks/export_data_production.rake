...
namespace :export_data_production do
    ...
    task :mysql => :environment do
        ...
        connection = PG::Connection.open(host: "db-postgresql-tor1-50618-do-user-10617726-0.b.db.ondigitalocean.com", port: 25060, dbname: "defaultdb", user: "doadmin", password: "2VqOyNr2AtXCVspv")
