	...
	jQuery(window).ready(function () {
		...
		loadScript('../assets/bootstrap.min.js', function() {
			...
			if(jQuery("body").hasClass('enable-materialdesign')) {
				loadScript('../assets/mdl/material.min.js');
			}
 ...
 **************************************************************** **/
	function _owl_carousel() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/owl-carousel/owl.carousel.min.js', function() {
		...
		if(_container2.length > 0) {
			...
			loadScript('../assets/owl-carousel-2/owl.carousel.min.js', function() {
 ...
 **************************************************************** **/
	function _flexslider() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/slider.flexslider/jquery.flexslider-min.js', function() {
 ...
 **************************************************************** **/
	function _lightbox() {
		...
		if(_el.length > 0) {
			...
			loadScript('../assets/magnific-popup/jquery.magnific-popup.min.js', function() {
 ...
 **************************************************************** **/
	function _youtubeBG() {
		...
		if(_container.length > 0) {
			loadScript('../assets/jquery.mb.YTPlayer.min.js', function() {
 ...
 **************************************************************** **/
	function _mixitup() {
		...
		if(_container.length > 0) {
			loadScript('../assets/mixitup/jquery.mixitup.min.js', function() {
 ...
 **************************************************************** **/
	function _wrotate() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/text-rotator/jquery.simple-text-rotator.min.js', function() {
 ...
 **************************************************************** **/
	function _lazyload() {
		...
		if(_container.length > 0) {
			loadScript('../assets/lazyload/jquery.lazyload.min.js', function() {
 ...
 **************************************************************** **/
	function _misc() {
		...
		if(portfolio_isotope_container.length > 0) {
			loadScript('../assets/isotope/isotope.pkgd.min.js', function() {
		...
		if(file_container.length > 0) {
			loadScript('../assets/custom.fle_upload.js');
		}
 ...
 **************************************************************** **/
	function _countDown() {
		...
		if(_container.length > 0 || _container2.length > 0) {
			...
			loadScript('../assets/countdown/jquery.countdown.pack.min.js', function() {
 ...
 **************************************************************** **/
	function _toastr(_message,_position,_notifyType,_onclick) {
		...
		if(_btn.length > 0 && _message != false) {
			...
			loadScript('../assets/toastr/toastr.js', function() {
				// toastr.clear();
 ...
 **************************************************************** **/
	function _charts() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/chart.easypiechart/dist/jquery.easypiechart.min.js', function() {
 ...
 **************************************************************** **/
	function _select2() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/select2/js/select2.full.min.js', function() {
 ...
 **************************************************************** **/
	function _form() {
		...
		if(jQuery('form.validate-plugin').length > 0) {
			...
			loadScript('../assets/jquery.form.min.js', function() {
				loadScript('../assets/jquery.validation.min.js');
			});
		...
		if(jQuery('form.validate').length > 0) {
			...
			loadScript('../assets/jquery.form.min.js', function() {
				loadScript('../assets/jquery.validation.min.js', function() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/jquery.maskedinput.js', function() {
 ...
 **************************************************************** **/
	function _pickers() {
		...
		if(_container_1.length > 0) {
			loadScript('../assets/bootstrap.datepicker/js/bootstrap-datepicker.min.js', function() {
				...
				if(jQuery().datepicker) {
					...
					_container_1.each(function() {
						...
						if(_lang != 'en' && _lang != '') { // load language file
							loadScript('../assets/bootstrap.datepicker/locales/bootstrap-datepicker.'+_lang+'.min.js');
						}
		...
		if(_container_2.length > 0) {
			loadScript('../assets/bootstrap.daterangepicker/moment.min.js', function() {
				loadScript('../assets/bootstrap.daterangepicker/daterangepicker.js', function() {
		...
		if(_container_3.length > 0) {
			loadScript('../assets/timepicki/timepicki.min.js', function() {
		...
		if(_container_4.length > 0) {
			loadScript('../assets/spectrum/spectrum.min.js', function() {
 ...
 **************************************************************** **/
	function _editors() {
		...
		if(_container_1.length > 0) {
			...
			loadScript('../assets/editor.summernote/summernote.min.js', function() {
				...
				if(jQuery().summernote) {
					...
					_container_1.each(function() {
						...
						alert(_lang);
							loadScript('../assets/editor.summernote/lang/summernote-'+_lang+'.js');
						}
		...
		if(_container_2.length > 0) {
			...
			loadScript('../assets/editor.markdown/js/bootstrap-markdown.min.js', function() {
				...
				if(jQuery().markdown) {
					...
					_container_2.each(function() {
						...
						if(_lang != 'en') { // Language!
							loadScript('../assets/editor.markdown/locale/bootstrap-markdown.'+_lang+'.js');
						}
 ...
 **************************************************************** **/
	function _pajinate() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/pajinate/jquery.pajinate.bootstrap.min.js', function() {
 ...
 **************************************************************** **/
	function _infiniteScroll() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/infinite-scroll/jquery.infinitescroll.min.js', function() {
 ...
 **************************************************************** **/
	function _zoom() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/image.zoom/jquery.zoom.min.js', function() {
 ...
 **************************************************************** **/
	function _autosuggest() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/typeahead.bundle.js', function() {
 ...
 **************************************************************** **/
	function _stepper() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/form.stepper/jquery.stepper.min.js', function() {
 ...
 **************************************************************** **/
	function _slimScroll() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/slimscroll/jquery.slimscroll.min.js', function() {
 ...
 **************************************************************** **/
	function _bgimage() {
		...
		if(_t.length > 0) {
			...
			loadScript('../assets/jquery.backstretch.min.js', function() {
 ...
 **************************************************************** **/
	function _widget_flickr() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/widget.jflickr/jflickrfeed.min.js', function() {
 ...
 **************************************************************** **/
	function _widget_twitter() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/widget.twittie/twittie.min.js', function() {
 ...
 **************************************************************** **/
	function _widget_dribbble() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/widget.dribbble/jribbble.min.js', function() {
 ...
 **************************************************************** **/
	function _widget_media() {
		...
		if(_container.length > 0) {
			...
			loadScript('../assets/widget.mediaelementbuild/mediaelement-and-player.min.js', function() {
