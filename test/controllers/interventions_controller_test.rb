...
class InterventionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create intervention" do
    assert_difference('Intervention.count') do
      post interventions_url, params: { intervention: { customer_id: @intervention.customer_id, employee_id: @intervention.employee_id, report: @intervention.report } }
    end
  ...
  test "should update intervention" do
    patch intervention_url(@intervention), params: { intervention: { customer_id: @intervention.customer_id, employee_id: @intervention.employee_id, report: @intervention.report } }
